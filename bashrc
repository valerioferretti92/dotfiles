...
then
	...
	if [[ $- == *i* ]]; then
		# Load ble.sh without auto-attaching
		[[ ! ${BLE_VERSION-} ]] && source ~/.local/share/blesh/ble.sh --noattach
	fi

	# Path to your oh-my-bash installation.
	export OSH='/home/valerio/.oh-my-bash'
	...
	# Only attach if BLE is loaded and NOT already attached to the session
	if [[ ${BLE_VERSION-} && ! ${BLE_ATTACHED-} ]]; then
	    ble-attach
	fi
fi
